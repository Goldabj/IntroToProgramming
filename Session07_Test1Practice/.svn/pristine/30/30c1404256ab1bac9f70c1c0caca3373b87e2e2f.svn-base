...
def test_problem4a():
    ...
    result = problem4a(window1, point2, 7)
    print('The value returned should be: 15')
    print('The value returned is in fact:', result)
...
def problem4b(m, point1):
    ...
    thickness = 1
    for k in range(m):
        total = thickness + thickness * n
        problem4a(window, rg.Point(x, y), n)
        n = n + 2
        y = y + 60
        thickness = thickness + 2
    window.render()
