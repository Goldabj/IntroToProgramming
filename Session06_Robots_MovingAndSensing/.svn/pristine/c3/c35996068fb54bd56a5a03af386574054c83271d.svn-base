...
def main():
    ...
    left = input('Enter the left wheel speed: ')
    right = input('Enter the right wheel speed: ')
    ...
    for k in range(3):
        ...
        linear = robot.getSensor(sensor1)
        print(linear)
        sensor2 = new_create.Sensors.angle
        angular = robot.getSensor(sensor2)
        print(angular)
...
# DONE: 3.  After implementing the above, experiment to learn
...
#          -- How far did the robot REPORT that it moved, in cm?
    ...
    # the robot should have moved 60cm
    # the robot moved 55.8cm
    # the robot reported it moved 57cm

    # the robot should have moved 60cm
    # the robot moved 55.8cm
    # the robot reported it moved 57.2cm


    # the robot should have moved 150cm
    # the robot moved 140cm
    # the robot reported it moved 120cm
