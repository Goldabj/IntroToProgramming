...
def test_sum_more_cosines():
    ...
    print('--------------------------------------------------')
    print(sum_more_cosines(0, 3))
    print(sum_more_cosines(-4, 2))
    print(sum_more_cosines(5, 7))
...
def test_count_sines_from():
    ...
    print('--------------------------------------------------')
    print(count_sines_from(3, 9))
    print(count_sines_from(7, 7))
    print(count_sines_from(4, 6))
...
def test_count_sines_vs_cosines():
    ...
    print('--------------------------------------------------')
    print(count_sines_vs_cosines(5))
    print(count_sines_vs_cosines(3))
    print(count_sines_vs_cosines(1))
