...
def test_count_items_bigger_than():
    ...
    print('--------------------------------------------------')
    numbers1 = [20, 30, 3, 5, 4, 22, 53]
    numbers2 = [3, 34, 44, 3, 21, 34, 3]
    print("the following line should print 3")
    print(count_items_bigger_than(numbers1, 20))
    print("the following line should print 4")
    print(count_items_bigger_than(numbers2, 15))
...
def test_count_positive_sines():
    ...
    print('--------------------------------------------------')
    numbers1 = [3, 4, 5, 6, 7, 8, 9]
    numbers2 = [3, 2, 5, 1, 0, 3, 5]
    print('the folowing line should print 4')
    print(count_positive_sines(numbers1))
    print('the folowing line should print 4')
    print(count_positive_sines(numbers2))
...
def test_sum_first_n():
    ...
    print('--------------------------------------------------')
    numbers1 = [48, -10, 50, 5]
    numbers2 = [343, 3, 23, 5, 6, 1, 3, 7]
    print('the following line should print 88')
    print(sum_first_n(numbers1, 3))
    print('the following line should print 380')
    print(sum_first_n(numbers2, 5))
