...
def test_init():
    ...
    print(elevator1.capacity, elevator1.people)
    print(elevator2.capacity, elevator2.people)
    print(elevator3.capacity, elevator3.people)
...
def test_remaining_capacity():
    ...
    # Add code below here to continue this test:
    print(elevator1.remaining_capacity())
    print(elevator2.remaining_capacity())
    print(elevator3.remaining_capacity())
...
def test_capacity_exceeded():
    ...
    # Add code below here to continue this test:
    print(elevator1.capacity_exceeded())
    print(elevator2.capacity_exceeded())
    print(elevator3.capacity_exceeded())
...
def test_oldest_person():
    ...
    # Add code below here to continue this test:
    print(elevator1.oldest_person())
    print(elevator2.oldest_person())
...
def test_elevator_with_oldest():
    ...
    # Add code below here to continue this test:
    print(elevator4.elevator_with_oldest(elevatorsA).capacity)
    print(elevator1.elevator_with_oldest(elevatorsA).capacity)
    print(elevator4.elevator_with_oldest(elevatorsB).capacity)
    print(elevator1.elevator_with_oldest(elevatorsB).capacity)
