...
def test_draw_points_on_circle():
    ...
    window = rg.RoseWindow(500, 500, 'testing draw points')

    circle1 = rg.Circle(rg.Point(250, 250), 200)
    draw_points_on_circle(window, circle1, 7, 'yellow')

    circle2 = rg.Circle(rg.Point(300, 100), 100)
    draw_points_on_circle(window, circle2, 100, 'red')
...
def test_pizza():
    ...
    pizza(window1, circle1, 4, 'blue')
    pizza(window2, circle1, 8, 'orange')
...
def test_polygon():
    ...
    polygon(window1, circle1, 6, 'red')
    polygon(window2, circle1, 8, 'blue')
...
def test_fancy_polygon():
    ...
    fancy_polygon(window1, circle1, 20, 7, 'purple')
    fancy_polygon(window2, circle1, 100, 30, 'green')
...
def fancy_polygon(window, circle, number_of_segments,
    ...
    points = generate_points_on_circle(circle, number_of_segments)
    for k in range(-hops_to_next_point, len(points) - hops_to_next_point):
