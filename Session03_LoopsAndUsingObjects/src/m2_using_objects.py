...
def circle_and_rectangle():
    ...
    point1 = rg.Point(30, 120)
    point2 = rg.Point(120, 200)
...
def lines():
    ...
    point3 = rg.Point(200, 225)
    point4 = rg.Point(250, 350)
...
def olympic_rings():
    ...
    circle5.fill_color = 'blue'

    circle1.attach_to(window.main_canvas)
    circle2.attach_to(window.main_canvas)
    circle3.attach_to(window.main_canvas)
    circle4.attach_to(window.main_canvas)
    circle5.attach_to(window.main_canvas)
