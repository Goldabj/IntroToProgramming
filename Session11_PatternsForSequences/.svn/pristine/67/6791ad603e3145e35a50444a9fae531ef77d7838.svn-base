...
Authors: David Mutchler, Amanda Stouder, Chandan Rupakheti, Katie Dion,
         ...
         and Brendan Goldacker.  January 2014.
...
def test_make_simple_list():
    ...
    print('--------------------------------------------------')
    print("the following line should print [1, 2, 3, 4, 5, 6]")
    print(make_simple_list(1, 6))
    print("the following line should print [5, 6, 7, 8, 9, 10, 11, 12]")
    print(make_simple_list(5, 12))
    print("the following line should print [1, 2, 3, 4]")
    print(make_simple_list(1, 4))
...
def test_make_simple_string():
    ...
    print('--------------------------------------------------')
    print("the following line should print '5-6-7-8-9-10-11-12-13-'")
    print(make_simple_string(5, 13))
    print("the following line should print '5-6-7-8-9-'")
    print(make_simple_string(5, 9))
    print("the following line should print '1-2-3-4-5-6-7-'")
    print(make_simple_string(1, 7))
...
def test_make_less_simple_string():
    ...
    print("the following line should print '1-2-3-4-5-6-7'")
    print(make_less_simple_string(1, 7))
...
def draw_shapes(shapes, window):
    ...
    for k in range(len(shapes)):
        shapes[k].attach_to(window.initial_canvas)
        window.render(0.3)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        rectangles = rectangles + [rg.Rectangle(circles[k].center, circles[k].radius * 2, circles[k].radius * 2)]
    return rectangles
