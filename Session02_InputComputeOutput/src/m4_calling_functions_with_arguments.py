...
def input_angle():
    ...
    input_radians = float(input("Give an angle in radians: "))
    print("sin(", input_radians, ") = ", math.sin(input_radians))
    print("cos(", input_radians, ") = ", math.cos(input_radians))
    print("sin^2(", input_radians, ") + cos^2(", input_radians, ") = ", 1)
