...
def print_distance_to_origin():
    ...
    input1 = float(input("Enter an x-coordinate: "))
    input2 = float(input("Enter a y-coordiante: "))
    distance = math.sqrt(input1 ** 2 + input2 ** 2)
    print(distance)
...
def print_logarithm():
    ...
    inputLog1 = float(input("Enter a number: "))
    print("The base-10 Logarithm of ", inputLog1, "is", math.log10(inputLog1))
