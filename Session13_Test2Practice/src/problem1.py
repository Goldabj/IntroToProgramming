...
def test_problem1a():
    ...
    # ------------------------------------------------------------------
    # DONE: Add at least 2 more tests.
    ...
    # ------------------------------------------------------------------
    # test two.
    test1 = [20, 30, 40, 12, 11, 90, 80]
    mutated1 = [20, 30, 11, 12, 40, 90, 80]
    ...
    # test three.
    test1 = [21, 79, 51, 84, 41, 79, 82]
    mutated1 = [21, 79, 41, 84, 51, 79, 82]
...
def problem1a(list_of_integers):
    ...
    # ------------------------------------------------------------------
    for k in range((len(list_of_integers) - 1) // 2):
        if list_of_integers[k] > list_of_integers[len(list_of_integers) - (k + 1)]:
            first = list_of_integers.pop(k)
            last = list_of_integers.pop(len(list_of_integers) - (k + 1))
            list_of_integers.insert(k, last)
            list_of_integers.insert(len(list_of_integers) - (k), first)
...
def problem1c(shape, colors):
    ...
    n = len(colors)
    rColor = colors[random.randrange(0, n)]
    shape.fill_color = rColor
