...
class BankAccount(object):
    ...
    def number_of_withdrawals(self):
        ...
        count = 0
        for k in range(len(self.transactions)):
            if 'draw' in self.transactions[k] and 'efuse' not in self.transactions[k]:
                count = count + 1
        return count
    ...
    def transfer_into(self, another_bank_account):
        ...
        self.withdraw(balance1)
        another_bank_account.deposit(balance1)
    ...
    def transfer_to_new_account(self):
        ...
        self.withdraw(original_balance)
        new_account = BankAccount(original_balance)
        return new_account
